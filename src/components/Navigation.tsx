      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <a href="#benefits" className="text-sm font-medium text-foreground hover:text-accent transition-colors">
              Benefits
            </a>
            <a href="#how-it-works" className="text-sm font-medium text-foreground hover:text-accent transition-colors">
              How It Works
            </a>
            <Button variant="default" size="lg" className="bg-gradient-to-r from-primary to-primary/90 shadow-md hover:shadow-lg transition-all">
              Get Started
            </Button>
          </div>
        ...
        {isMenuOpen && (
          <div className="lg:hidden py-4 space-y-4 border-t border-border">
            ...
            <a href="#benefits" className="block text-sm font-medium text-foreground hover:text-accent transition-colors">
              Benefits
            </a>
            <a href="#how-it-works" className="block text-sm font-medium text-foreground hover:text-accent transition-colors">
              How It Works
            </a>
            <Button variant="default" size="lg" className="w-full bg-gradient-to-r from-primary to-primary/90">
              Get Started
            </Button>
          </div>
        )}
